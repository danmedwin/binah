window.NEWS_DATA = {
 ...
 "items": [
  ...
  },
  {
   ...
   "source": "Latent Space",
   "category": "podcast",
   "date": "2026-09-25T23:14:41+00:00",
   "summary": "In 2023 most people doubted that there could be more than 1 or 2 frontier model labs. Now there are dozens.... and Stripe just bought the best known one for $7B.",
   "religionScore": 0,
   "religionHits": [],
   "audio": "https://api.substack.com/feed/podcast/217456046/69e6d188059a812b68e47c97b6495374.mp3",
   "image": "",
   "themes": [],
   "aiSummary": "Stripe acquired OpenRouter, a platform that routes requests to multiple AI models, for $7 billion. The deal reflects a shift in the AI landscape where dozens of frontier model providers now coexist rather than just 1-2 dominant labs.",
   "whyMatters": [
  ...
  {
   "title": "Beyond Prediction: Trust, Compassion, and the Promise that AI Will Cure Cancer",
   "link": "https://aiandfaith.org/insights/beyond-prediction/",
   "source": "AI and Faith",
   "category": "religion",
   "date": "2026-09-25T21:30:53+00:00",
   "summary": "The patient sitting across from the oncologist has just heard the cancer is spreading. Until a few moments ago, they were discussing treatment options. Now they are discussing time. Chemotherapy",
   "religionScore": 5,
   "religionHits": [],
   "audio": "",
   "image": "",
   "themes": [],
   "aiSummary": "An AI and Faith article examines AI's role in cancer treatment, exploring the gap between AI's predictive capabilities and the human, emotional dimensions of delivering difficult medical news (the blurb cuts off but frames AI promises against patient reality).",
   "whyMatters": [
  ...
  },
  {
   ...
   "category": "podcast",
   "date": "2026-09-25T18:07:32+00:00",
   "summary": "Jev is moving beyond viral demos into practical work, from analyzing ad campaigns and searching archives to prioritizing inboxes and checking AI writing. NLW breaks down six categories of real-world use cases, explains what makes this new “judgment model” different from an LLM, and offers a framework for deciding where its fast, inexpensive decisions fit into your workflows. AIDB Fall Listener Sur",
   "religionScore": 0,
   "religionHits": [],
   "audio": "https://anchor.fm/s/f7cac464/podcast/play/126304563/https%3A%2F%2Fd3ctxlq1ktw2nl.cloudfront.net%2Fstaging%2F2026-8-25%2F432662503-44100-2-4dbca7b913e13.mp3",
   "image": "https://d3t3ozftmdmh3i.cloudfront.net/staging/podcast_uploaded_nologo/41472609/41472609-1752234663609-8665756a468e5.jpg",
   "themes": [],
   "aiSummary": "Jev, a new \"judgment model\" distinct from large language models, is moving beyond demos into practical applications including ad analysis, archive searching, inbox prioritization, and AI writing verification. The episode breaks down six real-world use categories and offers guidance on workflow integration.",
   "whyMatters": [
    "Demonstrates emergence of specialized AI models designed for discrete decision tasks rather than general conversation",
    "Shows practical differentiation between model types, helping practitioners choose appropriate tools"
   ]
  },
  {
